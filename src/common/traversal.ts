...
export type TVisitNodeFn<State, StateType, Return> = (node: Ast.TNode, state: State & IState<StateType>) => Return;
export type TVisitChildNodeFn<State, StateType, Return> = (
    parent: Ast.TNode,
    node: Ast.TNode,
