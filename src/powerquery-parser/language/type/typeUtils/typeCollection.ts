...
// export interface TypeBuckets {
//     readonly maybeAction: ITypeKindCollection<Type.Action> | undefined;
//     readonly maybeAnyNonNull: AnyNonNullCollection | undefined;
//     readonly maybeAny: AnyCollection | undefined;
//     readonly maybeBinary: BinaryCollection | undefined;
//     readonly maybeDate: DateCollection | undefined;
//     readonly maybeDateTime: DateTimeCollection | undefined;
//     readonly maybeDateTimeZone: DateTimeZoneCollection | undefined;
//     readonly maybeDuration: DurationCollection | undefined;
//     readonly maybeFunction: FunctionCategory | undefined;
//     readonly maybeList: ListCategory | undefined;
//     readonly maybeLogical: LogicalCollection | undefined;
//     readonly maybeNoneCollection: NoneCollection | undefined;
//     readonly maybeNotApplicable: NotApplicableCollection | undefined;
//     readonly maybeNumber: NumberCategory | undefined;
//     readonly maybeNull: NullCollection | undefined;
...
//     readonly maybeTime: TimeCollection | undefined;
//     readonly maybeType: TypeCategory | undefined;
//     readonly maybeUnknown: UnknownCollection | undefined;
// }
...
export interface ITypeKindCategory<T extends Type.PqType> {
...
// export function categorize(types: ReadonlyArray<Type.PqType>): TypeBuckets {
...
function addToCategoryForPrimitive<T extends Type.PqType, C extends ITypeKindCategory<T> & TCategory>(
    categorizedType: TCategory,
    type: T,
): ITypeKindCategory<T> & TCategory {
    assertIsCategoryForType<T, C>(categorizedType, type);

    return {
        ...categorizedType,
        primitives: categorizedType.primitives.add(type),
    };
}
