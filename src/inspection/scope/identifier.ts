...
function inspectIdentifierExpression(state: IdentifierState, identifierExpr: TXorNode, isLeaf: boolean): void {
    ...
    switch (identifierExpr.kind) {
        case XorNodeKind.Ast: {
            ...
            const maybeInclusiveConstant: Ast.Constant<Ast.MiscConstantKind.AtSign> | undefined =
        ...
        case XorNodeKind.Context: {
            ...
            if (maybeInclusiveConstant !== undefined) {
                const inclusiveConstant: Ast.Constant<
                    Ast.MiscConstantKind.AtSign
                > = maybeInclusiveConstant.node as Ast.Constant<Ast.MiscConstantKind.AtSign>;
                // Adds the '@' prefix.
