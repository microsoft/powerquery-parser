...
function isPositionBeforeXorNode(position: Position, xorNode: NodeIdMap.TXorNode): boolean {
    switch (xorNode.kind) {
        case NodeIdMap.XorNodeKind.Ast:
...
function isPositionAfterXorNode(position: Position, xorNode: NodeIdMap.TXorNode): boolean {
    switch (xorNode.kind) {
        case NodeIdMap.XorNodeKind.Ast:
...
function isPositionBeforeContextNode(position: Position, contextNode: ParserContext.Node): boolean {
...
function isPositionOnContextNode(
    nodeIdMapCollection: NodeIdMap.Collection,
    position: Position,
...
function isPositionAfterContextNode(
    nodeIdMapCollection: NodeIdMap.Collection,
    position: Position,
    contextNode: ParserContext.Node,
): boolean {
...
function isPositionBeforeAstNode(position: Position, astNode: Ast.TNode): boolean {
    return isPositionBeforeTokenPosition(position, astNode.tokenRange.positionStart);
}

function isPositionOnAstNode(position: Position, astNode: Ast.TNode): boolean {
    return !isPositionBeforeAstNode(position, astNode) && !isPositionAfterAstNode(position, astNode);
}

function isPositionAfterAstNode(position: Position, astNode: Ast.TNode): boolean {
    return isPositionAfterTokenPosition(position, astNode.tokenRange.positionEnd);
}

function isPositionBeforeTokenPosition(position: Position, tokenPositionStart: TokenPosition): boolean {
...
function isPositionAfterTokenPosition(position: Position, tokenPositionEnd: TokenPosition): boolean {
    const positionLineNumber: number = position.lineNumber;
