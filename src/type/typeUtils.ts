...
export function genericFactory<T extends Type.TypeKind>(typeKind: T, isNullable: boolean): Type.IPrimitiveType {
...
function primitiveTypeMapKey(typeKind: Type.TypeKind, isNullable: boolean): string {
    return `${typeKind},${isNullable}`;
}

const primitiveTypeConstantMap: Map<string, Type.IPrimitiveType> = new Map<string, Type.IPrimitiveType>([
