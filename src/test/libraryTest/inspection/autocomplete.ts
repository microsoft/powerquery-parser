...
function expectNodesEqual(inspected: Inspection.Inspected, expected: AbridgedInspection): void {
    const actual: AbridgedInspection = inspected.autocompleteKeywords;
    ...
    describe(`Autocomplete`, () => {
        describe("partial keyword", () => {
            it("a|", () => {
                ...
                expectNodesEqual(expectParseOkInspectionOk(DefaultSettings, text, position), expected);
            });
            ...
            it("x a|", () => {
                ...
                expectNodesEqual(expectParseErrInspectionOk(DefaultSettings, text, position), expected);
            });
